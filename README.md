...
Total Profit: $2,065,362.60

Average Profit Margin: 34.80%

Total Order Volume: 5,000 orders

Total Units Sold: 27,594 units

Average Order Value (AOV): $1,187.15
...
Executive Dashboard (Dashboard): A consolidated, high-level view of core business KPIs, providing immediate visibility into overall organizational health.

Geographical Analysis (Region Analysis): Detailed PivotTable breakdowns evaluating Total Sales and Profit Margins across major global regions (Asia, Australia, Europe, North America, South America).

Temporal Tracking (Trends & YearlyTrends): Time-series analysis tracking order volume and revenue fluctuations across months, quarters, and years to identify seasonality and growth trajectories.

Product Analytics (Products): Categorical performance evaluation (Toys, Sports, Home & Kitchen, Electronics, Clothing, Books) tracking unit movement and profitability.

Salesforce Metrics (Salespeople): Individual performance tracking for account executives, measuring total sales, profit generation, and average deal size (e.g., Caleb Camacho, Diane Andrews).
...
Lookup & Reference Functions: Implementation of complex VLOOKUP and HLOOKUP matrices (found in the Lookups and Salesperson_Lookups sheets) to build relational data architectures and cross-reference region and salesperson performance.

Calculated Fields & Data Engineering: Development of derived metrics within the dataset, including programmatic extraction of Date components (Month-Year, Quarter, Year) and financial ratios (Profit Margin %).
...
Utilize the distinct analytical tabs to explore specific business queries (e.g., investigating Q4 electronics sales in the Products and Trends tabs).

Review the Lookups sheets to observe the underlying formulas powering the relational queries.
